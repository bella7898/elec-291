...
Forever:
	...
	; copy 12 bits of adc conversion into 32 bits x
	load_Y(40959) ;ref voltage
	lcall mul32
	load_Y(4095)
	lcall div32
	load_Y(27300)
	...
	lcall hex2bcd
	lcall DisplayFormattedPUTTY
	
	; Wait 1000ms (1sec) between conversions
	mov R2, #250
	lcall waitms
	mov R2, #250
	lcall waitms
